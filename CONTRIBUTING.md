...
To develop CoeAdapt-specific features (Navi chat, career tracking, account management), you'll need a valid Clerk key. Contact the maintainers or sign up at [coeadapt.com](https://coeadapt.com). See the [Environment configuration](README.md#environment-configuration) section in the README for details.
